...
export default function StatCard({
  ...
  return (
    <div
      className={cn(
        "stat-card group hover:border-white/[0.1] transition-all duration-300",
        colors.glow
      )}
    >
      <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-br from-transparent to-white/[0.03]" />
